...
class _RuralSunsetPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    ambientGlow.color = const Color(0xFFFFE082).withOpacity(0.25);
    canvas.drawCircle(Offset(sunX, sunY), 140, ambientGlow);

    final outerGlow = Paint()
      ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 45);
    outerGlow.color = const Color(0xFFFFCC80).withOpacity(0.40);
    canvas.drawCircle(Offset(sunX, sunY), 80, outerGlow);

    final midGlow = Paint()
      ..maskFilter = const MaskFilter.blur(BlurStyle.normal, 22);
    midGlow.color = const Color(0xFFFFB74D).withOpacity(0.55);
    ...
    final backHillPaint = Paint()
      ..color = const Color(0xFF1B5E20).withOpacity(0.50)
    ...
    final treePaint = Paint()
      ..color = const Color(0xFF1B5E20).withOpacity(0.60)
      ..style = PaintingStyle.fill;
    ...
    final bottomFade = Paint()
      ..shader = LinearGradient(
        ...
        colors: [Colors.transparent, const Color(0xFF0A1A0A).withOpacity(0.30)],
